...
#a computing cluster.
source('~/MIR_Combo_Targeting/Code/Network_Evolution/NP_Pipeline_MiR.R')
source('~/MIR_Combo_Targeting/Code/Network_Evolution/NP_Funcs_MiR.R')
df <- read.csv('~/MIR_Combo_Targeting/data_files/rld_Counts.csv') %>% as_tibble()
...
gibbs_pipeline(df = df_ready, filter_proportion = 1, ncores = 20)  #default is 1 less than the machine - can do more on cluster
